...
| 03 | **Νυχτερινή Βάρδια στο Σανατόριο του Μαινάλου** 🏥 ⭐ *ΝΕΟ* | Γιατρός ανακαλύπτει το σκοτεινό μυστικό ενός σανατορίου | Φεβ 2026 | [🔗](https://michelis2023.github.io/short-stories/nukhterine-bardia-sto-sanatorio-tou-mainalou.html) |
...
- **Δημοσιευμένα Έργα**: 21 ολοκληρωμένα διηγήματα σε ελληνικά
- **Συνολικές Λέξεις**: ~115.000+ λέξεις λογοτεχνίας
...
**Αριθμητικά Στοιχεία:**
- ✍️ 21 ολοκληρωμένα διηγήματα (15 παραδοσιακά + 6 γοτθικά)
- 📖 ~115.000+ λέξεις δημοσιευμένες
...
Είμαι συγγραφέας με διπλή δημιουργική ταυτότητα: από τη μία πλευρά διασώζω την ελληνική λαϊκή παράδοση μέσα από **15 παραδοσιακά διηγήματα** που αντλούν από τη μνήμη της Γορτυνίας Αρκαδίας, και από την άλλη δημιουργώ **6 γοτθικά διηγήματα τρόμου** εμπνευσμένα από τον Edgar Allan Poe και την ευρωπαϊκή γοτθική παράδοση.
...
#### 🆕 Πρόσφατο Διήγημα: "Νυχτερινή Βάρδια στο Σανατόριο του Μαινάλου"

Το νεότερο γοτθικό διήγημα διαδραματίζεται στο Μαίναλο το 1898 και αφηγείται την ιστορία του γιατρού Ανδρέα Καραμάνη, που αναλαμβάνει νυχτερινή βάρδια σε ένα σκοτεινό σανατόριο ψυχικών ασθενών. Ένα έργο για τον φόβο, την αγωνία και τα σκοτεινά μυστικά που κρύβονται στις σοφίτες της ιστορίας, εμπνευσμένο από τον Poe και την ατμόσφαιρα των παλιών ελληνικών νοσοκομείων.
...
Με **21 ολοκληρωμένα διηγήματα** και **~115.000 λέξεις** δημοσιευμένου υλικού, έχω δημιουργήσει έναν μοναδικό συνδυασμό:
