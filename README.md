...
Είμαι συγγραφέας με διπλή δημιουργική ταυτότητα: από τη μία πλευρά διασώζω την ελληνική λαϊκή παράδοση μέσα από **15 παραδοσιακά διηγήματα** που αντλούν από τη μνήμη της Γορτυνίας Αρκαδίας, και από την άλλη δημιουργώ **4 γοτθικά διηγήματα τρόμου** εμπνευσμένα από τον Edgar Allan Poe και την ευρωπαϊκή γοτθική παράδοση.
...
Με **19 ολοκληρωμένα διηγήματα** και **~100.000 λέξεις** δημοσιευμένου υλικού, έχω δημιουργήσει έναν μοναδικό συνδυασμό:
