...
*Διηγήματα • Νουβέλες • Φιλοσοφικά Δοκίμια • Ιστορικά Μελετήματα • Γοτθική Παράδοση • Φιλολογική Επιμέλεια*

🎭 **Διασώζω λαϊκές αφηγήσεις, οικογενειακή μνήμη και τοπική ιστορία μέσω του λόγου.**

> *«Η γραφή είναι η γέφυρα ανάμεσα στη μνήμη και στην αιωνιότητα.»*
...
### 📜 Φιλοσοφικά Δοκίμια — *Περί Βίου και Λόγου*

Συλλογή φιλοσοφικών πραγματειών που διερευνούν τα υπαρξιακά ζητήματα του ανθρώπου μέσα από την ελληνική σκέψη και τη βιωματική εμπειρία.
...
### 🏛️ Ιστορικά Μελετήματα — *Ιστορία & Πολιτισμός*

Τεκμηριωμένες έρευνες για την τοπική ιστορία, τη θρησκευτική παράδοση και τον πολιτισμό της Αρκαδίας και του Ελληνισμού.

| Τίτλος | Θέμα | Σύνδεσμος |
| :--- | :--- | :--- |
| **ΕΟΚΑ — 1η Απριλίου 1955** | Εθνική Αντίσταση & Κυπριακός Αγώνας | [Διαβάστε](https://michelis2023.github.io/meletemata-istoria-politismos/eoka-prwti-apriliou-1955.html) |
| **Η Γορτυνία στο Πέρασμα των Αιώνων** | Τοπική Ιστορία Αρκαδίας | [Διαβάστε](https://michelis2023.github.io/meletemata-istoria-politismos/i-gortunia-sto-perasma-ton-aionon.html) |
| **Η Γορτυνία ως Φύλακας Θρησκευτικών Παραδόσεων** | Θρησκεία & Έθιμα | [Διαβάστε](https://michelis2023.github.io/meletemata-istoria-politismos/i-gortunia-os-fylakas-thriskeftikon-paradoseon.html) |
| **Ημέρα Αγίας Μεγάλης Εβδομάδας στην Αρκαδία** | Λαογραφία & Θρησκευτικά Έθιμα | [Διαβάστε](https://michelis2023.github.io/meletemata-istoria-politismos/imera-agia-megali-evdomada-arkadia.html) |
...
### 🗂️ Αποθετήρια στο GitHub

Πέρα από τις ψηφιακές εκδόσεις που διαβάζετε ως ιστότοπους, ορισμένα έργα μου φιλοξενούνται και ως αποθετήρια στο GitHub, λειτουργώντας ως «εργαστήριο» και αρχείο για το περιεχόμενο.

| Repository | Σκοπός | Σύνδεσμος |
| :--- | :--- | :--- |
| `stavrodromio` | Κώδικας και αρχεία για το ψηφιακό αρχείο «Σταυροδρόμι – Κοινότητα», με κείμενα, άρθρα, υλικό τοπικής ιστορίας και ρεπορτάζ. | https://github.com/Michelis2023/stavrodromio |
| `short-stories` | Βάση για τη συλλογή «Γοτθικά Διηγήματα» με HTML σελίδες, ενημερώσεις και προσθήκες νέων ιστοριών. | https://github.com/Michelis2023/short-stories |
| `peri-viou-kai-logou` *(αν είναι/γίνει public)* | Δοκίμια και κείμενα της σειράς «Περί Βίου και Λόγου» σε μορφή ιστοσελίδων και αρχείων. | https://github.com/Michelis2023/peri-viou-kai-logou |

> Το GitHub χρησιμοποιείται εδώ κυρίως ως χώρος οργάνωσης, τεκμηρίωσης και σταδιακής επέκτασης των έργων μου.
